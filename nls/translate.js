...
define({
    root : {
        ...
        bulk_description: "Click on the list below to go to the Domain Bulk download section",
        interactive_description: "Click on the list below to go to the Domain Interactive Download section",
        metadata_description: "Click on the list below to go to the Domain Metadata section"
    },
    fr : true,
    es : true
});